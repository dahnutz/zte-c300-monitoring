...
func CorsMiddleware() func(next http.Handler) http.Handler {
	...
	allowedOrigins := getEnvAsSlice("CORS_ALLOWED_ORIGINS", nil)
	// Same-origin UI requests need no CORS. Never opt every website into
	// reading an API response, especially behind the UI's credential proxy.
